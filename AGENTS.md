...
- **代码/文档**：0.3.6 改动已就绪（`CHANGELOG.md`）；提交状态以 `git log` 为准
- **工坊**：线上版本 **0.3.4**（条目 3804204184）；0.3.5/0.3.6 已打包未上传（待正式服实机验收 + 用户确认后按「发布规则」上传）
- **功能现状**（除 0.3.5/0.3.6 外均已实机验收）：
